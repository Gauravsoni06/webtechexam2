...
var xmlString = "<?xml version = '1.0'?>" +
    "<CHRIST> " +
    "   <student rollNo = '1'> " +
    "      <STU_NAME>Aditya</STU_NAME> " +
    "      <STU_BRANCH>Computer Science</STU_BRANCH> " +
    "      <EMAIL>aditya@cs.christuniversity.in</EMAIL> " +
    "      <STU_COLLEGE>CHRIST COLLEGE</STU_COLLEGE> " +
    "   </student> "

    +
    "   <student rollNo = '2'> " +
    "      <STU_NAME>bhavika</STU_NAME> " +
    "      <STU_BRANCH>Data Science</STU_BRANCH> " +
    "      <EMAIL>bhavika@ds.christuniversity.in</EMAIL> " +
    "      <STU_COLLEGE>CHRIST COLLEGE</STU_COLLEGE> " +
    "   </student> "

    +
    "   <student rollNo = '3'> " +
    "      <STU_NAME>chanchal</STU_NAME> " +
    "      <STU_BRANCH>Computer Science</STU_BRANCH> " +
    "      <EMAIL>chanchal@cs.christuniversity.in</EMAIL> " +
    "      <STU_COLLEGE>CHRIST COLLEGE</STU_COLLEGE> " +
    "   </student> " +
    "</CHRIST> ";
